defmodule StreamTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StreamTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StreamTestWeb.Gettext, "errors", msg, opts)
    end
  end
